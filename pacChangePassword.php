...
$user = $action->retrieve_patient($_SESSION['id']);
if (isset($_POST['submit'])) {
    ...
    if (!isset($p) && !isset($np) && !isset($rp)) {
        ...
        $insertedOk = $action->changePass_patient($user->id, $pass);
        if ($insertedOk) {
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item" href="pacChangePassword.php">Change Password<span
            ...
            <form class="contact100-form validate-form" method="post" action="">
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="password" name="npass"
                           value="<?= (isset($_POST['npass'])) ? $_POST['npass'] : "" ?>" required
