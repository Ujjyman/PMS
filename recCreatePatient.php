...
// Allow certain file formats
    ...
    if (!isset($n) && !isset($fn) && !isset($s) && !isset($pid) && !isset($ph) && !isset($bd) && !isset($prof) && !isset($j) && !isset($g) && !isset($b) && !isset($e) && !isset($u) &&
        !isset($inr) && !isset($bt) && !isset($all) && !isset($anam) && !isset($photo)) {

        $pass = $valid->randomPassword();
        $hashpass = password_hash($pass, PASSWORD_BCRYPT);

        $insertedOk = $action->create_medical_record($newfilename, $_POST['name'], $_POST['father_name'], $_POST['surname'], $_POST['pid'], $_POST['gender'], $_POST['phone'], $_POST['address'], $_POST['prof'], $_POST['job'],
            $_POST['g'], $_POST['bd'], $_POST['bp'], $_POST['email'], $_POST['username'], $hashpass, $_POST['inr'], $_POST['pn'], $_POST['dc'], $user->id, $_POST['doctor'], $_POST['bt'], $_POST['rh'], $_POST['all'], $_POST['anam']);
        if ($insertedOk) {
            ...
            $pdf->Cell(0, 10, 'Date:  ' . $_POST['dc'], 0, 1, "R");
            ...
            $_POST['g'] = "";
            $_POST['doctor'] = '';
            echo "<script type='text/javascript' language='Javascript'>window.open('$file_name','_blank'); window.open('recCreatePatient.php','_self');</script>";
        } else {
            $msg = "Error while creating a patient!";
            echo "<script type='text/javascript'>alert(\"$msg\");</script>";
        }
    } else {
        ...
        <div class="wrap-contact100">
            <div class="contact100-pic js-tilt">
                <div class="container-contact100-form-btn">
                    <form action="recImportPatient.php" method="post" class="contact100-form validate-form"
                          enctype="multipart/form-data">
                        <button class="contact100-form-btn" name="file" type="submit" value="">Import from File</button>
                    </form>
                </div>
                <img src="imagesForm/img-07.png" data-tilt alt="IMG">
            </div>
            ...
            <form class="contact100-form validate-form" method="post" enctype="multipart/form-data">
                ...
                <div class="wrap-input100 validate-input">
                    <label style="color: #2f88fd; text-align:center">Surname*</label>
                ...
                <div class="wrap-input100 validate-input">
                    ...
                    <input class="input100" type="date" name="bd" data-date-format="Y-m-d"
                ...
                <div class="wrap-input100 validate-input">
                    ...
                    <input class="input100" type="text" name="prof"
                           value="<?= (isset($_POST['prof'])) ? $_POST['prof'] : "" ?>" required
                ...
                <div class="wrap-input100 validate-input">
                    ...
                    <input class="input100" type="text" name="job"
                           value="<?= (isset($_POST['job'])) ? $_POST['job'] : "" ?>" required placeholder="Job">
                    <span class="focus-input100"></span>
                    <?= (isset($j)) ? $j : "" ?>
                </div>

                <div class="wrap-input100 validate-input">
                    <label style="color: #2f88fd; text-align:center">Guardian's name and surname (if no type
                        'none')*</label>
                    <input class="input100" type="text" name="g" value="<?= (isset($_POST['g'])) ? $_POST['g'] : "" ?>"
                           required placeholder="Guardian's name and surname">
                    <span class="focus-input100"></span>
                    <?= (isset($g)) ? $g : "" ?>
                </div>
                ...
                <div class="wrap-input100 validate-input">
                    <label style="color: #2f88fd; text-align:center">Health insurance number*</label>
                    <input class="input100" type="text" name="inr"
                           value="<?= (isset($_POST['inr'])) ? $_POST['inr'] : "" ?>" required
                ...
                <div class="wrap-input100 validate-input">
                    ...
                    <input class="input100" type="date" name="dc" value="<?= date("Y-m-d") ?>" readonly>
                    <span class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100 validate-input" style="color: #2f88fd">
                    ...
                    if (isset($_POST['bt']) && $_POST['bt'] == 'A') {
                        ...
                        <?php
                    } else if (isset($_POST['bt']) && $_POST['bt'] == 'B') {
                        ?>
                        ...
                        <input type="radio" name="bt" value="O">O
                        <?php
                    } else if (isset($_POST['bt']) && $_POST['bt'] == 'AB') {
                        ?>
                        <input type="radio" name="bt" value="A">A
                        <input type="radio" name="bt" value="B">B
                        ...
                        <input type="radio" name="bt" value="O">O
                        <?php
                    } else if (isset($_POST['bt']) && $_POST['bt'] == 'O') {
                        ?>
                        <input type="radio" name="bt" value="A">A
                        <input type="radio" name="bt" value="B">B
                        <input type="radio" name="bt" value="AB">AB
                ...
                <div class="wrap-input100 validate-input" style="color: #2f88fd">
                    ...
                    if (isset($_POST['rh']) && $_POST['rh'] == 'Rh+') {
                        ...
                        ?>
                        <input type="radio" name="rh" value="Rh+" required>+
                        <input type="radio" name="rh" value="Rh-">-
                        <?php
                    }
                ...
                <div class="wrap-input100 validate-input">
                    ...
                    <textarea class="input100" type="text" name="all"
                              value="<?= (isset($_POST['all'])) ? $_POST['all'] : "" ?>"
                ...
                <div class="wrap-input100 validate-input">
                    ...
                    <textarea class="input100" type="text" name="anam"
                              value="<?= (isset($_POST['anam'])) ? $_POST['anam'] : "" ?>"
                ...
                <div class="wrap-input100 validate-input" style="color: #2f88fd;">
                    <label id="choose" for="options" style="color: #2f88fd; text-align:center">Family Doctor</label><br>
                    <select id="options" class="form-control selcls" name="doctor" required size="">
                        <option value="" style="" selected disabled> Select Doctor*</option>
                        <?php
