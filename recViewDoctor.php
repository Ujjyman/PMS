...
if (isset($_POST['details']) && isset($_SESSION['id'])) {
    ...
    $user = $crud->retrieve_doctor($_POST['details']);
        ...
        <div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" method="post">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><strong>Personal ID:</strong> <?php echo $user->personal_id ?></li>
                    ...
                    <li class="list-group-item"><strong>Speciality:</strong> <?php echo $user->speciality ?></li>
