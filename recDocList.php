                            ...
                            <div class="collapse navbar-collapse" id="medilifeMenu">
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <div class="collapse navbar-collapse" id="medilifeMenu">
                                        ...
                                        <!-- Login Button -->
                                        <a href="login.php" class="btn medilife-appoint-btn ml-30"> <span>Logout</span></a>
                                    </div>
...
<div class="bg-contact100" style="">
                ...
                <div style="width: 60rem; margin-left:-14%;">
                    ...
                    <table class="table table-hover" id="doctor_table">
                        ...
                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                            ...
                            ?>
                            <td>
                                <form style="margin: 0; padding: 0;" action="recViewDoctor.php" method="post">
                            ...
                            <td>
                                <form style="margin: 0; padding: 0;" action="recUpdateDoctor.php" method="post">
                                    <button style="display: inline;color: #2f88fd;" name="details" type="submit"
                                            value="<?= $row['id'] ?>">Update
                                    </button>
                                </form>
                            ...
                            <td>
                                <form style="margin: 0; padding: 0;" action="recDeleteDoctor.php" method="post">
                                    <button style="display: inline;color: #2f88fd;" name="details" type="submit"
    ...
    <script>
        function myFunction(a) {
            ...
            table = document.getElementById("doctor_table");
